    ...
    import { postPedido } from "./pedidos.services";
    ...
    const [selectmesas, setSelectMesas] = useState('')
    ...
    async function handleClick (){
        ...
        const Pedidos = JSON.stringify({ 
            ...
            id_mesa:selectmesas,
            datos:datos,
            precio_total:sumaCantidad,
            tipo_identificacion:tipo_identificacion,

        })
        try{
            const data = await postPedido(Pedidos);
            Swal.fire({
        ...
        <div className="animate__animated animate__fadeIn animate">
            ...
            <div class="container px-4 px-lg-5 my-5">
                ...
                <p class="lead fw-normal text-white-50 mb-0">
                    Registra el Pedido Atráves del formulario
                </p>
                </div>
            </div>
            </header>
                ...
                <div class="well well-sm">
                    ...
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                            <label htmlFor="name">
                                Nombre de la Persona del Pedido
                            </label>
                            <input
                                id="fname"
                                name="name"
